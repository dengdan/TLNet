...
from avod.core import constants, obj_utils, calib_utils
...
class KittiDataset:
    ...
    def load_samples(self, indices):
        ...
        for sample_idx in indices:
            ...
            cv_bgr_image_r = cv2.imread(self.get_rgb_image_r_path(
                sample_name))
            ...
            stereo_calib_p3 = calib_utils.read_calibration(self.calib_dir,
                                               int(sample_name)).p3
            ...
            sample_dict = {
                ...
                constants.KEY_LABEL_SCORE_2D: label_score_2d,

                constants.KEY_IMAGE_INPUT: image_input,
                constants.KEY_IMAGE_R_INPUT: image_r_input,
